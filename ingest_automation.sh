...
# Display message with cowsay
cowsay "Please drag and drop the DIGITAL REPOSITORY folder into the terminal and press Enter. Uf it doesn't exist, please create the folder now and drag it into the terminal and press Enter."
...
# Perform the file ingestion using rsync with progress and logging
rsync -aihW --progress --log-file="$log_file_path" "$artist_drive" "$digital_repository"
